    ...
    <h2 className="my-3">About us</h2>
        <div className="accordion" id="accordionExample">
            ...
            <div className="accordion-body" style={myStyle}>
                ...
                or overriding our default variables. It's also worth noting that just about any HTML can go within the <code>.
        ...
        <div className="accordion-item" style={myStyle}>
            ...
            <div className="accordion-body" style={myStyle}>
                ...
                stom CSS or overriding our default variables. It's also worth noting that just about any HTML can go within 
        ...
        <div className="container my-3">
            <button onClick={togglStyle} type="button" className="btn btn-primary">{btntext} </button>
        </div>
    </div>
    )
}